...
A `judged` entry's threshold is the confidence, from 0 to 1, at or above which a "violates" answer blocks. Every other entry leaves the Threshold cell empty.
...
| Id | The project never | Mode | Threshold |
|---|---|---|---|
