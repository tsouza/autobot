...
| **M1 / G-INTAKE** | M0-Q | installation and recovery; intake and adoption on real forge metadata; decision policy with per-class fallback and trust labels; narrow scope and finding routing | broader non-production orchestration, fixed routing |
