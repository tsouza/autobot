...
- **Acceptance suite** — The repository paths of the tests and checks a task's acceptance runs, named in its capsule's acceptance evidence; held out of the worker's reach and run against the pinned candidate by a `VerificationRun`. *(ROLES §2)*
