...
The reviser accepts every entry of either level; admission admits that accept only from the reviser, and the CLI is its product path. An agent never promotes a candidate.
