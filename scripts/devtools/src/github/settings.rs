...
mod tests {
    ...
    // Recorded from GET repos/tsouza/autobot/rulesets?includes_parents=false.
    const RULESETS_LIST: &str = r#"[{"id":23850705,"name":"main","target":"branch","source_type":"Repository","source":"tsouza/autobot","enforcement":"active","node_id":"RRS_lACqUmVwb3NpdG9yec5SZK5vzgFr7tE","_links":{"self":{"href":"https://api.github.com/repos/tsouza/autobot/rulesets/23850705"},"html":{"href":"https://github.com/tsouza/autobot/rules/23850705"}},"created_at":"2026-09-22T23:19:37.951Z","updated_at":"2026-09-22T23:19:38.004Z"}]"#;

    // Recorded from GET repos/tsouza/autobot/rulesets/23850705.
    const RULESET_DETAIL: &str = r#"{"id":23850705,"name":"main","target":"branch","source_type":"Repository","source":"tsouza/autobot","enforcement":"active","conditions":{"ref_name":{"exclude":[],"include":["~DEFAULT_BRANCH"]}},"rules":[{"type":"deletion"},{"type":"non_fast_forward"},{"type":"required_linear_history"},{"type":"pull_request","parameters":{"required_approving_review_count":0,"dismiss_stale_reviews_on_push":false,"required_reviewers":[],"require_code_owner_review":false,"require_last_push_approval":false,"required_review_thread_resolution":true,"require_extra_approval_for_unattributed_changes":true,"allowed_merge_methods":["squash"]}}],"node_id":"RRS_lACqUmVwb3NpdG9yec5SZK5vzgFr7tE","created_at":"2026-09-22T23:19:37.951Z","updated_at":"2026-09-22T23:19:38.004Z","bypass_actors":[],"current_user_can_bypass":"never","_links":{"self":{"href":"https://api.github.com/repos/tsouza/autobot/rulesets/23850705"},"html":{"href":"https://github.com/tsouza/autobot/rules/23850705"}}}"#;

    // Recorded from GET repos/tsouza/autobot, keeping the merge and feature fields.
    const REPO: &str = r#"{"id":1062540311,"name":"autobot","full_name":"tsouza/autobot","private":false,"default_branch":"main","has_issues":true,"has_projects":true,"has_wiki":false,"has_discussions":false,"allow_squash_merge":true,"allow_merge_commit":false,"allow_rebase_merge":false,"allow_auto_merge":true,"delete_branch_on_merge":true,"allow_update_branch":false,"use_squash_pr_title_as_default":true,"squash_merge_commit_title":"PR_TITLE","squash_merge_commit_message":"PR_BODY","merge_commit_title":"MERGE_MESSAGE","merge_commit_message":"PR_TITLE"}"#;
